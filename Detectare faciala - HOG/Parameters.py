...
class Parameters:
    def __init__(self):
        self.base_dir = 'C:/Users/eduar/Desktop/Anul 3/Vedere Artificiala/Tema3 Rezolvare/data'
        ...
        self.overlap = 0.3
        self.number_positive_examples = 13426  # numarul exemplelor pozitive
        self.number_negative_examples = 10000  # numarul exemplelor negative
        self.threshold = 0.5  # toate ferestrele cu scorul > threshold si maxime locale devin detectii
