...
params.dim_cell = 3  # dimensiunea celulei
params.overlap = 0.3
params.number_positive_examples = 6713  # numarul exemplelor pozitive #practic dublu
...
# concatenam de doua ori pentru ca am dublat numarul
positive_labels = np.concatenate((np.ones(params.number_positive_examples), (np.ones(params.number_positive_examples))))
train_labels = np.concatenate((positive_labels, np.zeros(negative_features.shape[0])))
